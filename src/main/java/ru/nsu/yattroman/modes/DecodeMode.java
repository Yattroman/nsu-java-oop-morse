...
public class DecodeMode extends Mode{
    ...
    public void executeMode(TextHandler mainTextHandler, Alphabet alphabet, SymbolStat symbolsStatistics, Encoder encoder, Decoder decoder){
        ...
        while (mainTextHandler.readTextLine()) {
            String temp = decoder.decodeLine(mainTextHandler.getLine(), alphabet, symbolsStatistics);
            resultText += temp + '\n';
        }
        mainTextHandler.writeResultInFile("decoderRes.txt", resultText);
    }
